...
class Record extends Model {
  ...
  const Record._internal({required this.id, required userID, createdAt, updatedAt}): _userID = userID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Record({String? id, required String userID}) {
  ...
  Record copyWith({String? id, String? userID}) {
    return Record._internal(
      id: id ?? this.id,
  ...
  static final QueryField ID = QueryField(fieldName: "record.id");
...
class _RecordModelType extends ModelType<Record> {
