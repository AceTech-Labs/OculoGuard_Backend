...
<div class="flex items-center justify-center w-screen h-screen  space-x-0 bg-orange-300 " >
	<div class="flex h-screen  p-7 bg-slate-400" >
	{/* Component Start */}
	<div class="flex flex-col items-center  w-60 h-full overflow-hidden text-blue-900 bg-white rounded">
  ...
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1z"/>
		...
		<a class="flex items-center justify-center w-full h-16 mt-auto bg-blue-900 hover:bg-white text-white  hover:text-blue-900 hover:border-blue-900"  href="#">
			<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
